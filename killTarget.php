...
{
	$_SESSION['DM2-status'] = "<p><strong>Error:</strong> That is not your targets pin.<br/><br/> If you think they're a lying cheat,<br /> their overall can kill them manually. <br /> Or maybe you messed up, who knows?</p>";
	echo('<SCRIPT LANGUAGE="JavaScript">redirURL = "index.php"; self.location.href = redirURL;</script>');
}
