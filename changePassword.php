...
The Assassins Staff";
	...
	$_SESSION['DM2-status']="<p>Password successfully changed. Please login to test it.</p>";
	echo('<SCRIPT LANGUAGE="JavaScript">redirURL = "login.php";self.location.href = redirURL;</script>');
}
else if ($password)
{
	$_SESSION['DM2-status']="<p><strong>Error:</strong> Old password is incorrect</p>";
		echo('<SCRIPT LANGUAGE="JavaScript">redirURL = "myProfile.php";	self.location.href = redirURL;</script>');
}
else
{
	$_SESSION['DM2-status']="<p><strong>Error:</strong> New password cannot be blank</p>";
		echo('<SCRIPT LANGUAGE="JavaScript">redirURL = "myProfile.php";	self.location.href = redirURL;</script>');
}
?>
